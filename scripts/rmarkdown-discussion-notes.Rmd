...
template <- here::here("scripts","analysis-plan-template.Rmd")
```

In this folder are examples:

1.  Our analysis plan template as an RMarkdown is in this folder called analysis-plan-template.Rmd. You can look at as a text file of as an RMarkdown.
